        ...
        <div className=' flex flex-col align-center justify-center '>
            ...
            <div className=' flex mt-5 max-[768px]:flex-col relative'>
                    <div className=' flex flex-col flex-1 relative group'>
                        <img src={Hospital} alt="Venues" className=' w-[500px] h-full hover:opacity-25 max-[768px]:w-full object-cover' loading='lazy'/>
                    ...
                    <div className=' flex flex-col flex-1 relative'>
                        <img src={Naifest} alt="Venues" className=' w-[500px] h-full hover:opacity-25 max-[768px]:w-full object-cover' loading='lazy'/>
                        <div className=' absolute left-[45%] top-[45%] font-bold hover:opacity-100 z-1'>Events</div>
                    </div>
                    <div className=' flex flex-col flex-1 relative'>
                        <img src={Mall} alt="Venues" className=' w-[500px] hover:opacity-25 max-[768px]:w-full object-cover' loading='lazy'/>
